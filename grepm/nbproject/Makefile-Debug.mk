...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/grepm

dist/Debug/GNU-Linux-x86/grepm: ${OBJECTFILES}
...
${OBJECTDIR}/src/LineNumber.o: nbproject/Makefile-${CND_CONF}.mk src/LineNumber.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/LineNumber.o src/LineNumber.cpp

${OBJECTDIR}/src/CircBuffer.o: nbproject/Makefile-${CND_CONF}.mk src/CircBuffer.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/CircBuffer.o src/CircBuffer.cpp
...
${OBJECTDIR}/src/MultiGrep.o: nbproject/Makefile-${CND_CONF}.mk src/MultiGrep.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/MultiGrep.o src/MultiGrep.cpp

${OBJECTDIR}/src/Grep.o: nbproject/Makefile-${CND_CONF}.mk src/Grep.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Grep.o src/Grep.cpp

${OBJECTDIR}/src/BoostGrep.o: nbproject/Makefile-${CND_CONF}.mk src/BoostGrep.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/BoostGrep.o src/BoostGrep.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Linux-x86/grepm
